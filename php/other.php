...
<head>
    ...
    <meta name="keywords" content="комоди на замовлення рівне, виготовлення комодів у рівному, барна стійка на замовлення рівне, комод купить у рівному,
    ...
    <meta name="description" content="Ми виготовляємо меблі різного типу – від полички до масштабних об’єктів, будь-які нестандартні корпусні меблі:
     комп'ютерні столи, барні стійки, комоди, серванти, вітрини на замовлення у Рівному.">
    <title><?php echo $lang->lang_ua['other_main_title'][0]; ?></title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="top-content">
                    <div class="header"><h1><?php echo $lang->lang_ua['other_top_content_h1'][0]?></h1></div>
                    <div class="content">
                        <?php foreach ($lang->lang_ua['other_top_content_content'] as $value ){?>
                            <p><?php echo $value; ?></p>
                        <?php }?>
                    </div>
                </div>
                ...
                <div class="bottom-content">
                    <h2><?php $lang->lang_ua['other_bottom_content_h1'][0]; ?></h2>
                    <?php foreach ($lang->lang_ua['other_bottom_content_p'] as $value ){?>
                        <p><?php echo $value; ?></p>
                    <?php }?>
                </div>
            </div>

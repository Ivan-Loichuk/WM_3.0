...
<head>
    ...
    <title><?php echo $lang->lang_ua['mattresses_main_title'][0]; ?></title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8">
                <div class="top-content">
                    <div class="header"><h1><?php echo $lang->lang_ua['mattresses_top_content_h1'][0]?></h1></div>
                    <div class="content">
                        <?php foreach ($lang->lang_ua['mattresses_top_content_content'] as $value ){?>
                            <p><?php echo $value; ?></p>
                        <?php }?>
                    </div>
                </div>
                ...
                <div class="bottom-content">
                    <h2><?php $lang->lang_ua['mattresses_bottom_content_h1'][0]; ?></h2>
                    <?php foreach ($lang->lang_ua['mattresses_bottom_content_p'] as $value ){?>
                        <p><?php echo $value; ?></p>
                    <?php }?>
                </div>

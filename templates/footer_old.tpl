        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="left-footer">
                    ...
                    <div>
                        <a title="west mebli в вконтакте замовлення корпусних меблів"><i class="fa fa-vk"></i></a>
                        ...
                        <a href="https://www.facebook.com/groups/WestMebli" title="west mebli на фейсбуку корпусні меблі на замовлення рівне"><i class="fa fa-facebook-f"></i> </a>
                    </div>
